      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-28 pb-16 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              <button className="w-full sm:w-auto bg-primary text-primary-foreground px-8 py-3.5 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 hover:opacity-90 transition-all glow-gold">
                Open Account <ArrowRight className="w-4 h-4" />
              </button>
              <button className="w-full sm:w-auto glass-card px-8 py-3.5 rounded-xl text-sm font-medium text-foreground hover:bg-secondary transition-all">
                Link instantly
              </button>
            </div>
          </div>
